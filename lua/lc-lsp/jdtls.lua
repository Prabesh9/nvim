...
local jdtls_binary = "/home/" .. USER .. "/Programs/Java/scripts/jdtls.sh"

require('jdtls').start_or_attach({cmd = { jdtls_binary }, filetypes = {"java"}, root_dir = require('jdtls.setup').find_root({'gradle.build', 'pom.xml'})})
...
if not lspconfig.jdtls then
    configs.jdtls = {
        default_config = {
            ...
            init_options = {
                jvm_args = {},
                workspace = "/home/lucifer/workspace"
            };
